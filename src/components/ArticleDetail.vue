<template>
  <el-dialog v-model="dialogVisible" class="mypopstyle" :width="pageWidth" :lock-scroll="false">
    <div class="article">
...
const pageWidth = computed(() => {
  let win_width = useWindowSize().width.value
  var page_width = win_width > 1600 ? 1600 : win_width
